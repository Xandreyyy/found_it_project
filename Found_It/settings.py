...
SECRET_KEY = 'django-insecure-cd!uhxekwpm!ru&zns)llusqz8qsdsmek3!gd+^&_49evtt%n3'
...
# define the dir which collectstatic will use 
STATIC_ROOT = BASE_DIR / "static"

# used to refer files in STATIC_ROOT
STATIC_URL = 'static/'
